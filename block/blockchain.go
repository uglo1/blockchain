...
// Blockchainに関してはchainの部分のみをUnmarshalするようにカスタマイズ
...
// 他のサーバーのチェーンで長いものを探し、見つかれば自分のチェーンを置き換える
...
/*
 * TransactionRequest(from WalletServer)
 */
